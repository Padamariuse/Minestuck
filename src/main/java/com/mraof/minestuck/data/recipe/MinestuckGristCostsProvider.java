...
public class MinestuckGristCostsProvider extends RecipeProvider
{
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> recipeSaver)
	{
		...
		GristCostRecipeBuilder.of(MSItems.SURPRISE_FORK).grist(BUILD, 124).grist(RUST, 85).grist(AMBER, 58).grist(IODINE, 40).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.TUNING_FORK).grist(BUILD, 76).grist(RUST, 45).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.ELECTRIC_FORK).grist(BUILD, 85).grist(RUST, 38).grist(URANIUM, 6).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.EDISONS_FURY_OFF).grist(BUILD, 145).grist(RUST, 64).grist(URANIUM, 17).build(recipeSaver);
		...
		GristCostRecipeBuilder.of(MSItems.PITCHFORK).grist(BUILD, 16).grist(RUST, 4).build(recipeSaver);
